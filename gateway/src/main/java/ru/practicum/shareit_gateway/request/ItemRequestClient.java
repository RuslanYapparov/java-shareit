...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> save(long userId, ItemRequestRestCommand itemRequestRestCommand) {
        return post("", userId, itemRequestRestCommand);
    }

    public ResponseEntity<Object> getAllRequestsOfRequester(long userId) {
        return get("", userId);
    }
